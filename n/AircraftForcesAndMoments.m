...
prop_force = Q*ap.S*[CT; 0; 0];    %assumes thrust along body x-axis;
prop_moment = [0;0;0];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Gravity Force
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
weight_inertial = [0;0;aircraft_parameters.W];
weight_body = TransformFromInertialToBody(weight_inertial, euler_angles);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Total Forces and Moments
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
aircraft_forces = aero_forces + prop_force + weight_body;
aircraft_moments = aero_moments + prop_moment;
